                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea rows="4" id="input_descripcion" name="input_descripcion"
                                                      class="form-control no-resize"
                                                      placeholder="Descripción general de la liga..."></textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <i class="material-icons">date_range</i>
                                        ...
                                        <div class="form-line">
                                            <input type="text" name="input_fecha_ini" id="input_fecha_ini"
                                                   ...
                                                   placeholder="Escoja la fecha inicio..."
                                                   required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <span class="input-group-addon">
                                    <i class="material-icons">date_range</i>
                                        ...
                                        <div class="form-line">
                                            <input type="text" name="input_fecha_fin" id="input_fecha_fin"
                                                   class="datepicker form-control"
                                                   placeholder="Escoja la fecha final..." required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <span class="input-group-addon">
                                    <i class="material-icons">assignment</i>
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="input_categoria"
                                                   id="input_categoria">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <b>Valor inscripción <i
                                                class="font-bold col-green material-icons">card_membership</i></b>
                                    <div class="input-group">
                                <span class="input-group-addon">
                                    <i class="material-icons">attach_money</i>
                                </span>
                                        <div class="form-line">
                                            <input type="number" class="form-control" name="input_incripcion"
                                                   id="input_incripcion">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <span class="input-group-addon">
                                    <i class="material-icons">attach_money</i>
                                        ...
                                        <div class="form-line">
                                            <input type="number" class="form-control" name="input_amarilla"
                                                   id="input_amarilla">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea rows="4" id="input_reglas" name="input_reglas"
                                                      class="form-control no-resize"
                                                      placeholder="Reglas del torneo..."></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
